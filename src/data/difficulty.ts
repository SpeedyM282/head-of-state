...
export const difficulties: Record<Difficulty, DifficultyConfig> = {
  easy: withTurns({
    id: 'easy',
    startStats: { economy: 65, treasury: 65, approval: 65, eliteLoyalty: 65, stability: 65, development: 60, corruption: 20 },
  ...
  normal: withTurns({
    id: 'normal',
    startStats: { economy: 50, treasury: 50, approval: 50, eliteLoyalty: 50, stability: 50, development: 45, corruption: 30 },
  ...
  hard: withTurns({
    id: 'hard',
    startStats: { economy: 40, treasury: 35, approval: 45, eliteLoyalty: 40, stability: 40, development: 35, corruption: 45 },
